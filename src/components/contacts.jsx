...
const Contacts = () => {
  return (
    <div className="contacts">
      ...
      <iframe className="contacts__map" src="https://yandex.ru/map-widget/v1/?um=constructor%3Ab788d2076a07b067c75e15a21bf89632daacb0f0256c3653ff8c875fea49c247&amp;source=constructor" width="431" height="271" style={{border:0}}></iframe>
    </div>
  );
};
